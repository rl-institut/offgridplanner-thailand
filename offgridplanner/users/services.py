...
def send_mail(to_address, msg, subject='Activate your PeopleSun-Account'):
    ...
    message["To"] = to_address if '@' in to_address else os.environ.get("MAIL_ADDRESS_LOGGER")
    ...
    with smtplib.SMTP(smtp_server, smtp_port) as server:
        ...
        try:
            ...
            server.sendmail(os.environ.get("MAIL_ADDRESS"), message["To"], message.as_string())
